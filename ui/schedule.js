...
function formatTimeTitle(departDate, arriveDate) {
  return [
    "Depart: ",
...
var ScheduledTrip = React.createClass({
  ...
  render: function() {
    ...
    return el("article", {
      ...
      children: [
        renderTime({
          dateTime: firstStop.date.toISOString(),
          children: formatTime(firstStop.date),
          title: formatTimeTitle(firstStop.date, lastStop.date),
        }),
        " ",
        renderTrainName({
  ...
  renderHeading: function() {
    return el("h2", {
      children: [
        ...
        " to ",
        el("em", null, this.getArrivingStationName()),
      ],
    });
  },
